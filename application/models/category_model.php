...
class category_model extends CI_Model{
    ...
    function get_parent(){
         $currency = $this->db->query("select * from category where parent_id=0")->result();
    ...
    function get_by_id($id){
        // $data=array('id'=>$id);
         ...
         $currency = $this->db->query("select * from category where id=$id")->row_array();
         // $currency = $this->db->query("select * from category")->result_array();
        return $currency;
    }
    ...
    function get_name($id){
        // $data=array('id'=>$id);
         ...
         $currency = $this->db->query("select name from category where id='$id'")->row_array();
         // $currency = $this->db->query("select * from category")->result_array();
        return $currency;
    }
