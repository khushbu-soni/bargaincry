...
class Deal extends CI_Controller {
	...
	public function editdeal(){
		if(isset($_GET)){
			...
			$this->data['category_info']=$this->category->get_parent();
	        $this->data['subcat_info']=$this->category->get_sub();
			$this->data['dealtype']=$this->dealtype->get();
	...
	public function add(){
			$this->data['merchants']=$this->merchant->getActive();
			$this->data['category']=$this->category->get_parent();
			$this->data['subcategory']=$this->category->get_sub();
			$this->data['country']=$this->country->get();
			$this->data['state']=$this->state->get();
			$this->data['city']=$this->city->get();
			$this->data['town']=$this->town->get();
	...
	public function inventory(){
	 ...
	 function adddeal(){
        ...
        $dealtype_info=$this->dealtype->get_name($_POST['dealtype_id']);
        $merchant_info=$this->merchant->get_name($_POST['merchant_id']);
        $category_info=$this->category->get_name($_POST['category_id']);
        $subcat_info=$this->category->get_name($_POST['subcategory_id']);
        $country_info=$this->country->get_name($_POST['country_id']);
        $state_info=$this->state->get_name($_POST['state_id']);
        $city_info=$this->city->get_name($_POST['city_id']);
        $town_info=$this->town->get_name($_POST['town_id']);
        $category_info=$this->category->get_name($_POST['category_id']);
        $SKU=$_POST['SKU'];
        $url_key=$_POST['url_key'];
        $search_string=$dealtype_info['name'].','.$SKU.','.$url_key.''.$merchant_info['name'].','.$country_info['name'].','.
        				$state_info['name'].','.$city_info['name'].','.$town_info['name'].','.$category_info['name'].','.$subcat_info['name'];
   ...
   //      exit();
	...
	function unmarkFeatured(){
			if(isset($_GET)){
				$id=$_GET['id'];
				$this->deal->unmarkFeatured($id);
			}
		}
