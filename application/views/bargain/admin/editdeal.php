               ...
               <form role="form"  method="post"  enctype="multipart/form-data" action='<?php echo base_url()?>admin/deal/edit'>
                <div class='col-md-3'>
                   <div class="form-group">
                    <input type="text" class="form-control" id="name" name="name" value='<?php echo $deal['name'];?>' placeholder="Name" required>
                    <input type="hidden" class="form-control" id="id" name="id" value='<?php echo $deal['id'];?>' placeholder="Name" required>
                    </div>
                    <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <select id="category_id" name="category_id" class="form-control">
                      <?php foreach ($category_info as $junk) { ?>
                      <option value="<?php echo $junk->id;?>" <?php if($junk->id==$deal['category_id']) echo "selected" ?>><?php echo $junk->name?></option>
                      <?php }?>
                    </select>
                  </div>
                  <div class="form-group">
                    ...
                    <select id="subcategory_id" name="subcategory_id" class="form-control">
                      <?php foreach ($subcat_info as $junk) { ?>
                      <option value="<?php echo $junk->id;?>" <?php if($junk->id==$deal['subcategory_id']) echo "selected" ?>><?php echo $junk->sub_category?></option>
                      <?php }?>
                    </select>
                  </div>
                    <div class="form-group">
                ...
                <div class='col-md-3'>
                 ...
                 <div class="form-group">
                    <input type="text" id="datepicker" class="form-control"  name="valid_from" placeholder="Valid From" value='<?php $date=date_create($deal['valid_from']);
echo date_format($date,"Y/m/d"); ?>' required>
                    ...
                    <div class="form-group">
                    <input type="text" id="to_datepicker" class="form-control"  name="valid_to" placeholder="Valid To" value='<?php $date=date_create($deal['valid_to']);
echo date_format($date,"Y/m/d"); ?>' required>
                        <span class="help-block"><p id="characterLeft" class="help-block ">Deal Valid To</p></span>                    
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control" id="SKU" name="SKU" placeholder="SKU" value='<?php echo $deal['SKU'];?>' required>
                        <span class="help-block"><p id="characterLeft" class="help-block ">SKU</p></span>                    
                  </div> 
                 <div class="form-group">
                    <input type="text" class="form-control" id="url_key" name="url_key" placeholder="URL" value='<?php echo $deal['url_key'];?>' required>
                ...
                <div class="form-group">
                   ...
                   <div class="form-group">
                      ...
                      <option value="1" <?php if($deal['visibilty']==1) echo "selected" ?>>Not Visible Individually</option>
                      <option value="2" <?php if($deal['visibilty']==2) echo "selected" ?>>Catalog</option>
                      <option value="3" <?php if($deal['visibilty']==3) echo "selected" ?>>Search</option>
                      <option value="4" <?php if($deal['visibilty']==4) echo "selected" ?>>Catalog & Search</option>
                    </select>
                ...
                <div class='col-md-3'>
                  <div class="form-group">
                    <textarea class="form-control" type="textarea" id="highlights" name='highlights' placeholder="Highlights" maxlength="140" rows="7"><?php echo $deal['highlights'];?></textarea>
                        <span class="help-block"><p id="characterLeft" class="help-block ">Highlights</p></span>                    
                  </div>
                        
                  <div class="form-group">
                    <textarea class="form-control" type="textarea" id="policies" name='policies' placeholder="Policies" maxlength="140" rows="7"><?php echo $deal['policies'];?></textarea>
                ...
                <div class='col-md-3'>
                   ...
                   <div class="form-group">
                    <textarea class="form-control" type="textarea" id="about" name='about' placeholder="about" maxlength="140" rows="7"><?php echo $deal['about'];?></textarea>
