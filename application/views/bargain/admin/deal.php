                  ...
                  <tbody >
                    ...
                    <tr>
                      ...
                      <td>
                        <?php 
                        if($junk->is_featured){?>
                        <button class='btn btn-xs btn-warning warning_44' id='disable' onclick='unmarkFeatured(<?php echo $junk->id;?>)'><span class="glyphicon glyphicon-check" aria-hidden="true"></span></button>
                        <?php } ?>
                         <?php if(!$junk->is_featured){?>
                        <button class='btn btn-danger' id='enable' onclick='markFeatured(<?php echo $junk->id;?>)'>X</button>
                        <?php } ?>
...
function deleteDeal(id){
      ...
      $.ajax({
        type:'GET',
        url: "<?php echo base_url()?>admin/deal/markFeatured",
        data:{id:id},
        success: function(result){
          window.location.href='';
    }});
     ...
     function unmarkFeatured(id){
      $.ajax({
        type:'GET',
        url: "<?php echo base_url()?>admin/deal/unmarkFeatured",
        data:{id:id},
        success: function(result){
          window.location.href='';
    }});
