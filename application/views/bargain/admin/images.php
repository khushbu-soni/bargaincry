           ...
           <div class="xs tabls">
            <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
              ...
              <div class="panel-body no-padding" style="display: block;">
               <div class='col-md-12'>
                <form role="form"  method="post"  enctype="multipart/form-data" action='<?php echo base_url()?>admin/deal/addImage'>
                ...
                <div class="input-group">
                    ...
                    <input type="hidden"name='deal_id' class="form-control" value='<?php echo $_GET['id'];?>' readonly>
                </div>
