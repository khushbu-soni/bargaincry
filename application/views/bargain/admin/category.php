...
$(document).ready(function(){
	...
	$.ajax({url: "<?php echo base_url()?>admin/category/get", success: function(result){
...
function ediCategory(id){
    	$.ajax({
    		type:'GET',
    		url: "<?php echo base_url()?>admin/category/getEditForm",
    		data:{id:id},
...
function addCategory(){
    	$.ajax({
    		type:'GET',
    		url: "<?php echo base_url()?>admin/category/getAddForm",
    		success: function(result){
