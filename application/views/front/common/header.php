              ...
              <div class="col-sm-4 col-md-2  col-xs-5 list-inline list-unstyled no-margin">
                <p class="no-margin">
                 <a href="index.php"><img src="<?php echo base_url();?>assets/images/dummy_logo.png" class="img-responsive">
                      ...
                      <div class="pull-right col-sm-6 col-md-4  col-xs-7 top_nav">
                        <ul class="list-inline list-unstyled pull-right">
                          <li class="active hide1">
                            <a href="contact.php">
                              <i class="ti-cart">
                              </i>
                              Contact us
                      ...
                      <div class="search-form bg-banner  ">
        <div class="container">
          <div class="row">
            <div class="col-md-10 pull-left ">
              <div class="row">
              
              <div class="toggle-menu col-md-1">
               <ul class="nav navbar-nav pull-right">
                              <li class="dropdown ">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">  
                                  </i>
                                  <i class="fa fa-bars bar1"></i>
                ...
                <div class="col-md-6 col-xs-5">
                    ...
                    <input type="text" class="form-control" id="search_product" placeholder="Enter Product">
                    </div>
                    </div>
                    ...
                    <input type="text" class="form-control" id="search_city" placeholder="Enter Location">
                    </div>
                </div>
             
               <div class="col-sm-2 col-md-2 col-xs-1">               <a class="btn
btn-raised ripple-effect btn-success btn-block pull-left" >
<i class="fa fa-search"></i> </a>               
                        <div id="pardiv">
                  <div class="cart1"><a href="#"> <i class="fa fa-shopping-cart"></i></a></div>
