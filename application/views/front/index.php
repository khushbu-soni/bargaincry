...
<head>
  ...
  <link href="<?php echo base_url();?>assets/front/owl.carousel/owl.carousel.css" rel="stylesheet">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/<?php echo base_url();?>assets/front/css/font-awesome.min.css">
              ...
              <ul class="slides">
                <li>
                  <div class="col-sm-7 col-lg-8 omega">
                    <article class="bg-image entry-lg" data-image-src="<?php echo base_url();?>assets/images/deal-10.jpg">
                ...
                <li>
                  <div class="col-sm-7 col-lg-8 omega">
                    <article class="bg-image entry-lg" data-image-src="<?php echo base_url();?>assets/images/deal-11.jpg">
                      <div class="deal-short-entry bg-green">
                        <p>
                ...
                <li>
                  <div class="col-sm-7 col-lg-8 omega">
                    <article class="bg-image entry-lg" data-image-src="<?php echo base_url();?>assets/images/deal-3.jpg">
                ...
                <div class="deal-entry  green">
                  ...
                  <footer class="info_bar clearfix">
                    <ul class="unstyled list-inline row">
                      ...
                      <li>
         <!-- AddToAny BEGIN -->
                        <a class="a2a_dd" href="https://www.addtoany.com/share"><img src="<?php echo base_url();?>assets/images/share.png" width="80" height="30" border="0" alt="Share"/></a>
           ...
           <div class="row" data-gutter="15" style="margin:20px 0px;">
                <div class="col-md-4">
                    <div class="banner" style="background-color:#83599A;">
                        ...
                        <img class="banner-img" src="<?php echo base_url();?>assets/images/1-i.png" alt="Image Alternative text" title="Image Title" style="bottom: -8px; right: -32px;">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="banner" style="background-color:#EF4D9C;">
                        ...
                        <img class="banner-img" src="<?php echo base_url();?>assets/images/2-i.png" alt="Image Alternative text" title="Image Title" style="bottom: -22px; left: 0; width: 235px;">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="banner" style="background-color:#FEA92E;">
                        ...
                        <img class="banner-img" src="<?php echo base_url();?>assets/images/3-i.png" alt="Image Alternative text" title="Image Title" style="top: -4px; right: -15px; width: 220px;">
                    </div>
                </div>
            </div>
            <!--/row -->
